...
const ModalComponent = ({toggleModal}) => (
    <>
        <div className="modal">
            ...
            <p className="p-pad">Floobz are a series of NFTs created using a combination of shaders for the web and Three.js. The animations you're seeing are being pulled directly from an NFT smart contract published on the Ethereum Rinkeby Test Network.</p>
